    ...
    embeds: [
      {
        ...
        title: "Experiments",
        description:
          "I'm a small bot made by <@728342296696979526> to explore Discord guild experiments. Type `/` to view my commands. Join my [support server](https://discord.gg/BYubfNrzkU)!",
        footer: {
